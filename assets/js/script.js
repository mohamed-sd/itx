...
(function () {
  ...
  /* ---------- Portfolio filter & contact form ----------
     On index.php the portfolio is rendered dynamically from the API and the
     contact form uses real mailto behaviour — both are wired up in
     assets/js/home.js so they only run on the homepage. */
  ...
  function applyLang(lang) {
    ...
    // Notify dynamic (JS-rendered) sections — e.g. the AJAX "Our Works" grid.
    try { document.dispatchEvent(new CustomEvent("itx:langchange", { detail: { lang } })); } catch (e) {}
  }
